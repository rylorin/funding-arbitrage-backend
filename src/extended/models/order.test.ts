...
import * as generateNonceModule from "../utils/generate-nonce";
import { Decimal, Long } from "../utils/number";
import { Order } from "./order";
import { type OrderContext } from "./order.types";

const CTX: OrderContext = {
  assetIdCollateral: Decimal("1508159369509269042908118660797226224713309535454600628063900735297932481180"),
